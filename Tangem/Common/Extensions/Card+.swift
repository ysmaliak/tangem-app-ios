...
//                && !canSkipSD {
    ...
    var isDemoCard: Bool {
        let demoCards: [String] = [
            ...
            "AB01000000045060", // Note BTC //TODO: Remove before release
            "AB02000000045028", // Note ETH //TODO: Remove before release
            "AC79000000000004", // Wallet 4.46 //TODO: Remove before release
            // Tangem Wallet:
            "AC01000000041100",
            "AC01000000042462",
            "AC01000000041647",
