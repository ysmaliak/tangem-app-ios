            ...
            .flatMapLatest { input in
                ...
                return Deferred {
                    Future<Void, Never> { [userTokenListManager = manager.userTokenListManager] promise in
                        ...
                        userTokenListManager.update(with: updatedUserTokenList) // TODO: Andrey Fedorov - Implement more robust updating logic with background work and retries support (IOS-4297)
                        promise(.success(()))
                    }
                }
            }
