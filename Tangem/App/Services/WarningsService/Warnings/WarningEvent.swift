...
extension WarningEvent: NotificationEvent {
    ...
    var title: NotificationView.Title {
        switch self {
        case .rateApp:
            return .string("Rate the app") // TODO: Andrey Fedorov - Localize
        case .failedToVerifyCard:
    ...
    var description: String? {
        ...
        case .rateApp:
            return "How do you like Tangem?" // TODO: Andrey Fedorov - Localize
        case .failedToVerifyCard:
    ...
    func style(tapAction: NotificationView.NotificationAction? = nil, buttonAction: NotificationView.NotificationButtonTapAction? = nil) -> NotificationView.Style {
        ...
        case .rateApp:
            return .withButtons([
                .init(
                    action: { _, _ in }, // FIXME: Andrey Fedorov - Test only, remove when not needed
