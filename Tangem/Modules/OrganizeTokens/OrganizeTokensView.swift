...
struct OrganizeTokensView: View {
    ...
    private var dragAndDropController = OrganizeTokensDragAndDropController(
        cellSelectionThresholdHeight: 68.0 // TODO: Andrey Fedorov - Use constant or dynamic value
    )
        ...
        GeometryReader { geometryProxy in
            ScrollViewReader { scrollProxy in
                                ...
                                content: {
                                    ForEach(indexed: sectionViewModel.items.indexed()) { itemIndex, itemViewModel in
                                        ...
                                        makeCell(viewModel: itemViewModel, indexPath: indexPath, parametersProvider: parametersProvider)
                                            ...
                                            .id(itemViewModel.id)
                                            .background(
                                                // TODO: Andrey Fedorov - Get rid of separate geometry reader here
                ...
                .onChange(of: dragGestureLocation) { value in
                    ...
                    let diff = 68.0 // TODO: Andrey Fedorov - Use constant or dynamic value

                    // TODO: Andrey Fedorov - Move scroll logic into controller
                    if locationY < diff {
