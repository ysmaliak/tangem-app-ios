...
public struct Wallet {
    ...
    func validateTransaction(amount: Amount, fee: Amount?) -> ValidationError? { //TODO: Move to walletMamager base
    ...
    private func validate(amount: Amount) -> Bool { //TODO: Move to walletMamager base
    ...
    func createTransaction(amount: Amount, fee: Amount, destinationAddress: String) -> Result<Transaction,ValidationError> { //TODO: Move to walletMamager base
