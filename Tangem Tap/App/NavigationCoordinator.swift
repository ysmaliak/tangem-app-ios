...
//    @Published var detailsToCurrencySelection: Bool = false
//    @Published var detailsToDisclaimer: Bool = false
//    @Published var detailsToSecurityManagement: Bool = false
//    @Published var detailsToCardOperation: Bool = false
}
